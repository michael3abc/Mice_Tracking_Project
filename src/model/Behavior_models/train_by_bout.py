...
from utils.datasets_loader import build_dataloaders 
from utils.model_factory import build_model

from utils.data_preprocess import load_and_clean
from utils.sampler import sliding_windows, sample_windows_by_bout, assign_bout_ids, print_bouts_per_behavior, print_windows_per_behavior
...
if __name__ == "__main__":
    import yaml
    cfg = yaml.safe_load(open(r"src\model\Behavior_models\config_by_bout.yaml", encoding="utf-8"))
    main(cfg)
